...
abstract class TestAbstract extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        if (class_exists($this->_sTestClass) === true) {
            ...
            $this->assertInstanceOf('\\Testy\\Util\\Parallel\\TransportInterface', $this->_object);
            $this->assertInstanceOf('\\Testy\\Util\\Parallel\\TransportInterface', $this->_object->setup(array(
                'dir' => \Testy\Util\Parallel\Execute::DIR,
                'server' => 'localhost',
                'port' => 11211
            )));
        }
